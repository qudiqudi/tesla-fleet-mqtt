...
ENTITIES = [
    ...
    ("number", "charge_current_request", {"name": "Charge current request",
                                          ...
                                          "min": 0, "max": 32, "step": 1}),
    # --- firmware ----------------------------------------------------------
    ("sensor", "car_version", {"name": "Firmware version", "state_topic": v("Version"),
                               "value_template": "{{ value_json }}", "icon": "mdi:cellphone-information"}),
    ("sensor", "software_update_version", {"name": "Firmware update version",
                                           "state_topic": v("SoftwareUpdateVersion"),
                                           "value_template": "{{ value_json }}",
                                           "icon": "mdi:cellphone-arrow-down"}),
    ("sensor", "software_update_status", {"name": "Firmware update status",
                                          "state_topic": ha("software_update_status"),
                                          "icon": "mdi:cellphone-arrow-down"}),
    # --- active route ------------------------------------------------------
    ("sensor", "active_route_destination", {"name": "Route destination",
                                            "state_topic": v("DestinationName"),
                                            "value_template": "{{ value_json }}"}),
    ("sensor", "active_route_latitude", {"name": "Route destination latitude",
                                         "state_topic": v("DestinationLocation"), "unit_of_measurement": "°",
                                         "icon": "mdi:latitude", "value_template": "{{ value_json.latitude }}"}),
    ("sensor", "active_route_longitude", {"name": "Route destination longitude",
                                          "state_topic": v("DestinationLocation"), "unit_of_measurement": "°",
                                          "icon": "mdi:longitude", "value_template": "{{ value_json.longitude }}"}),
    ("sensor", "active_route_minutes_to_arrival", {"name": "Route minutes until destination",
                                                   "state_topic": v("MinutesToArrival"),
                                                   "device_class": "duration", "unit_of_measurement": "min"}),
    ("sensor", "active_route_traffic_minutes_delay", {"name": "Route traffic delay",
                                                      "state_topic": v("RouteTrafficMinutesDelay"),
                                                      "device_class": "duration", "unit_of_measurement": "min"}),
    ("sensor", "active_route_energy_at_arrival", {"name": "Route energy at arrival",
                                                  "state_topic": v("ExpectedEnergyPercentAtTripArrival"),
                                                  "device_class": "battery", "unit_of_measurement": "%"}),
    # --- trip (derived by tlwriter) ----------------------------------------
    ("sensor", "trip_distance", {"name": "Trip distance", "state_topic": ha("trip_distance"),
                                 "device_class": "distance", "unit_of_measurement": "km"}),
    ("sensor", "trip_duration_sec", {"name": "Trip Duration", "state_topic": ha("trip_duration_sec"),
                                     "device_class": "duration", "unit_of_measurement": "s"}),
    ("sensor", "trip_kwh", {"name": "Trip energy consumed", "state_topic": ha("trip_kwh"),
                            "device_class": "energy", "unit_of_measurement": "kWh"}),
    ("sensor", "trip_avg_kwh", {"name": "Trip energy consumption", "state_topic": ha("trip_avg_kwh"),
                                "device_class": "energy_distance", "unit_of_measurement": "Wh/km"}),
    ("sensor", "trip_max_power", {"name": "Trip max. power", "state_topic": ha("trip_max_power"),
                                  "device_class": "power", "unit_of_measurement": "kW"}),
    ("sensor", "trip_max_speed", {"name": "Trip max. speed", "state_topic": ha("trip_max_speed"),
                                  "device_class": "speed", "unit_of_measurement": "km/h"}),
    ...
    ("sensor", "time_to_full_charge", {"name": "Time to full charge", "state_topic": v("TimeToFullCharge"),
                                       "device_class": "duration", "unit_of_measurement": "h"}),
    ("sensor", "fast_charger_brand", {"name": "Fastcharger brand", "state_topic": v("FastChargerType"),
                                      "value_template": "{{ value_json }}", "icon": "mdi:ev-station"}),
    ("sensor", "open_windows", {"name": "Windows opened", "state_topic": ha("open_windows"),
                                "icon": "mdi:car-door"}),
    # --- tpms (built below) ------------------------------------------------
]
